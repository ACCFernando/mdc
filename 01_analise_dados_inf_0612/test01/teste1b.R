...
## Perguntas:
## Você deve criar, na variável alunos, um data frame utilizando os vetores fornecidos. 
## Além disso, sempre que utilizar algum dado já existente no arquivo, você deve referir-se a esse data 
## frame (ou seja, você só pode utilizar os vetores fornecidos para criar esse data frame).
...
alunos$p_min <- rowMins(alunos[, c(2:5)])*1i

medquad <- sqrt(Re(rowSums(alunos[, c(2:6)]**2)) / 3)
