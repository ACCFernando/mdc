...
setwd("~/workspace/mdc/03_aprendizado_supervisionado_I_inf_0615/test02")
...
# Outra possibilidade seria substituir pelos vizinho mais proximo, etc. 
...
# (isso evita vazamento de informacao do treino para a validacao)
...
# e a minha preferida (desde que perfome bem) dado que nao altera o conjunto de treinamento: adicionar pesos
# a funcao de custo para cada classe de acordo com a frequencia da mesma

## 03. Normalizando os dados para treinamento
...
# Por questao de conveniencia e tempo iremos usar pesos para lidar com o 
# desbalanceamento das nossas classes e avaliar todos os modelos com relacao a isso
